  ...
  return (
    ...
    >
      <motion.h1
        ...
        className='text-5xl  text-center md:text-6xl lg:text-7xl leading-snug text-blue mb-0 md:mb-20 font-bold flex-1 md:mr-10'
      >
        Tax Calendar
      </motion.h1>
